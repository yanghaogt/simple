...
<div class="widget-content autoHeader" >
	<table class="table table-striped table-bordered table-hover" style="min-width:1200px;">
		<thead>
			<tr>
				<th style="width:100px;"><input type="text" name="key" value="${example.key!}" class="form-control" style="width:100%;"/></th>
				<th style="width:100px;"><input type="text" name="classId" value="${example.classId!}" class="form-control" style="width:100%;"/></th>
				<th style="width:100px;"><input type="text" name="uid" value="${example.uid!}" class="form-control" style= "width:100%;"/></th>
				<th style="width:100px;"><input type="text" name="state" value="${example.state!}" class="form-control" style="width:100%;"/></th>
				<th style="width:130px;"><@shDateBeginEnd "createDateSh" example.createDateSh! /></th>
				<th style="width:130px;"><@shDateBeginEnd "useDateSh" example.useDateSh! /></th>
			</tr>
		</thead>
		<thead>
			<tr>
