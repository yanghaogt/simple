...
(function($) {
	...
	DateTimePicker.prototype = {
		...
		init : function(element, options) {
			...
			this.component = this.$element.is(".input-append") ? this.$element
					.find(".add-on") : false;
		...
		click : function(e) {
			...
			if (target.length === 1) {
				...
				case "span":
					...
					if (this.viewMode !== 0) {
						this._date = UTCDate(this.viewDate.getUTCFullYear(),
								this.viewDate.getUTCMonth(), this.viewDate
										.getUTCDate(),
								this._date.getUTCHours(), this._date
					...
					if (target.is(".day")) {
						...
						this._date = UTCDate(year, month, day, this._date
								...
								this._date.getUTCSeconds(), this._date
										.getUTCMilliseconds());
						this.viewDate = UTCDate(year, month, Math.min(28, day),
								0, 0, 0, 0);
						this.fillDate();
						this.set();
						this.notifyChange()
	...
	function getTemplate(timeIcon, pickDate, pickTime, is12Hours) {
		if (pickDate && pickTime) {
			return '<div class="bootstrap-datetimepicker-widget dropdown-menu" style="z-index:29891016;">'
					+ "<ul>"
			...
			return '<div class="bootstrap-datetimepicker-widget dropdown-menu" style="z-index:29891016;">'
					+ '<div class="timepicker">'
					+ TPGlobal.getTemplate(is12Hours) + "</div>" + "</div>"
		} else {
			return '<div class="bootstrap-datetimepicker-widget dropdown-menu" style="z-index:29891016;">'
					+ '<div class="datepicker">'
					+ DPGlobal.template
